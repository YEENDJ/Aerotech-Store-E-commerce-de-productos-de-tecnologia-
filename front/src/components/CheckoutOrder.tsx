...
export default function Checkout() {
  ...
  return (
    <section className="w-full max-w-3xl mx-auto p-6 flex flex-col gap-6">
  ...
  type="submit"
  className="bg-azulElectrico text-white py-3 rounded-lg mt-4 hover:bg-Verde-Azulado transition cursor-pointer"
>
  Confirmar compra
</button>
