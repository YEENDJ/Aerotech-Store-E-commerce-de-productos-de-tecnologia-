...
export default function HeroVideo2() {
  return (
    <section className="relative h-[50vh] w-[80%] mx-auto overflow-hidden flex rounded-xl bg-GrisClaro">
      <video
        key="id"
    ...
    "
      >
        <h2 className="text-4xl font-bold drop-shadow-lg">DJI OSMO ACTION 6 PRO</h2>
      </div>
    </section>
  )
}
