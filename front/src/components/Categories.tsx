  ...
  return (
    <section className="w-full py-10 bg-GrisClaro">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-2xl shadow p-8 flex flex-col items-center justify-center hover:shadow-lg transition cursor-pointer">
        ...
        <div className="bg-white rounded-2xl  p-8 flex flex-col items-center justify-center shadow hover:shadow-lg  transition cursor-pointer">
