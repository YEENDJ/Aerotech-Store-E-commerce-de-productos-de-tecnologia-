    ...
    <footer className="w-full bg-gray-900 text-gray-300 py-6 mt-10">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-3">
        ...
        <div className="flex gap-6 text-sm">
          <a  className="hover:text-white transition">Política de privacidad</a>
          <a href={PATHROUTES.TERMS} className="hover:text-white transition">Términos y condiciones</a>
